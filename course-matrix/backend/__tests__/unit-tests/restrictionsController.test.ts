...
import {instanceOfErrorResponse, Json,} from '@pinecone-database/pinecone/dist/pinecone-generated-ts-fetch/db_control';
          ...
          if (key === 'timetables') {
            return {
              ...
              eq: jest.fn().mockImplementation((key, value) => {
                ...
                if (key === 'user_id' &&
                    value ===
                        'testuser03-f84fd0da-d775-4424-ad88-d9675282453c') {
                  return {
...
describe('POST /api/timetables/restrictions', () => {
  ...
  test(
      'should return error code 400 and error message: \'calendar id is required\'',
      async () => {
  ...
  test(
      'should return error code 400 and error message: \'Start time or end time must be provided\'',
      async () => {
        const user_id = 'testuser03-f84fd0da-d775-4424-ad88-d9675282453c';
        const newTimetable = {
          calendar_id: '1',
  ...
  test(
      'should create a new timetable given calendar_id, start_time and end_time',
      async () => {
        const user_id = USER1;
  ...
  test(
      'should return error code 404 and error message: Calendar id not found',
      async () => {
        const user_id = 'testuser03-f84fd0da-d775-4424-ad88-d9675282453c';
        const newRestriction = {
          calendar_id: '1',
...
describe('PUT /api/timetables/restrictions/:id', () => {
  ...
  test(
      'should return error code 400 and message: calendar id is required ',
      async () => {
  ...
  test(
      'should return error code 404 and message: Restriction id does not exist',
      async () => {
        // Make sure the test user is authenticated
        const user_id = 'testuser03-f84fd0da-d775-4424-ad88-d9675282453c';
        const timetableData = {
...
describe('DELETE /api/timetables/:id', () => {
  ...
  test(
      'should return error code 404 and message: Calendar id not found and id not found',
      async () => {
        // Make sure the test user is authenticated
        const user_id = 'testuser03-f84fd0da-d775-4424-ad88-d9675282453c';
